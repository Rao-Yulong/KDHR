...
class KDHR(torch.nn.Module):
    def __init__(self, ss_num, hh_num, sh_num, embedding_dim, batchSize, drop):
        ...
        self.convSH_TostudyS_2 = GCNConv_SH(embedding_dim, 256)
        ...
        self.convSH_TostudyS_2_h = GCNConv_SH(embedding_dim, 256)
        ...
        self.SI_bn = torch.nn.BatchNorm1d(512)
    ...
    def forward(self, x_SH, edge_index_SH, x_SS, edge_index_SS, x_HH, edge_index_HH, prescription, kgOneHot):
        ...
        #融合
        x_SH9 = (x_SH1 + x_SH2 + x_SH6 + x_SH7) / 4.0
        ...
        # 融合
        x_SH99 = (x_SH11 + x_SH22 + x_SH66 + x_SH77) / 4.0
        ...
        e_synd_norm = e_synd_norm.view(-1, 512)
